...
* 【完整版】：包括系统功能、基础设施、会员中心、数据报表、工作流程、微信公众号、CRM、ERP 等功能
* 【精简版】：只包括系统功能、基础设施功能，不包括会员中心、数据报表、工作流程、微信公众号、CRM、ERP 等功能
...
项目可以是 SCRM 系统、OA 系统、物流系统、ERP 系统、CMS 系统、HIS 系统、IM 聊天、微信公众号、微信小程序等等。
